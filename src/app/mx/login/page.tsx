                            ...
                            <div className="form-control mt-4">
                                ...
                                <div className="input-group">
                                    <div className="input input-bordered flex items-center w-full">
                                        ...
                                        <button
                                            type="button"
                                            className="btn btn-ghost btn-sm h-full aspect-square"
